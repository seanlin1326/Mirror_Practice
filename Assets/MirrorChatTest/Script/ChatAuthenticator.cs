...
namespace MirrorTest.Chat
{
    public class ChatAuthenticator : NetworkAuthenticator
    {
        ...
        {
            playerName = username;
            loginUI.ClearErrorMessageLabel();
            loginUI.SetActiveErrorMessageLabelObj(false);
        ...
        public void OnAuthResponseMessage(AuthResponseMessage msg)
        {
            ...
            else
            {
                ...
                loginUI.SetErrorMessageContent(msg.message);
                loginUI.SetActiveErrorMessageLabelObj(true);
